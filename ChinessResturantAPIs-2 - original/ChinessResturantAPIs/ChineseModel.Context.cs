...
namespace ChinessResturantAPIs
{
    ...
    public partial class ChiDragonDbEntities : DbContext
    {
        public ChiDragonDbEntities()
            : base("name=ChiDragonDbEntities")
        {
        }
        ...
        public virtual DbSet<OrderMenue> OrderMenues { get; set; }
